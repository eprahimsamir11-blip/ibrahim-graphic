...
import { LogOut, Menu, X, Home, Users, ShoppingBag, Briefcase, Mail, Settings, Image } from 'lucide-react';
...
const menuItems = [
  ...
  { label: 'الخدمات', href: '/admin/services', icon: ShoppingBag },
  { label: 'الرسائل', href: '/admin/messages', icon: Mail },
  { label: 'الصور', href: '/admin/gallery', icon: Image },
    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-b border-gray-200 dark:border-dark-700">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">لوحة الإدارة</p>
        </div>
